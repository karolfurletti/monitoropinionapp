...
class Filter extends React.Component{
  ...
  componentDidMount(){
    ...
    this.props.FiltroMaster_Comparacao(this.props.concorrente_id, this.state.interval_init, this.state.interval_fim, 'geral')
  }
  ...
  handleSend = () => {
    ...
    this.sleep(500).then(() => {
      ...
      this.props.FiltroMaster_Comparacao('1234', this.props.concorrente_id, this.state.interval_init, this.state.interval_fim, 'geral')
        this.setState({
          opinions_by_cronology: this.props.opinions_by_cronology
        })
    });
    ...
    return (
      ...
      >
        ...
        <DialogContent>
          ...
          <SyncAltIcon className="IconEnterCalendar"></SyncAltIcon>
