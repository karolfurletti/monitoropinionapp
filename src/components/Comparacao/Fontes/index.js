        ...
        <div className="comparacao">
            ...
            <div className="coluna-3-graphs">
                <div className="colunm3">
                    ...
                    <PieChart variante={this.props.variante}></PieChart>
                </div>
            </div>
            ...
            <div className="coluna-1-graph">
                ...
                <PieChart2 variante={this.props.variante}></PieChart2>
                </div>
            </div>
            ...
            <div className="row-3">
                <div className="item">
                    ...
                    <Badge color="secondary">
                        <Typography className="titulo">{this.props.variante === 'concorrente'? this.props.PercentOpinionsPositiveConcorrente: this.props.PercentOpinionsPositive}% Positivos</Typography>
                    </Badge>
                </div>
                <div className="item" >
                    <Badge color="secondary">
                    ...
                    <Badge color="secondary">
                        <Typography className="titulo">{this.props.variante === 'concorrente'? this.props.PercentOpinionsNegativeConcorrente: this.props.PercentOpinionsNegative}% Negativos</Typography>
                    </Badge>
                </div>
            </div>
        </div>
