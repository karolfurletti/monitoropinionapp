      ...
      <div className="ItensFont2">
        ...
        <div className="ItemFont2">
          ...
          <div className="IconNameFont2">
            ...
            <div className="ProfitFont2">{this.props.PercentForEachPlataformaConcorrente.twitter}%</div>
        </div>
        ...
        <div className="ItemFont2">
          ...
          <div className="ProfitFont2">{this.props.PercentForEachPlataformaConcorrente.instagram}%</div>
        </div>
        ...
        <div className="ProfitFont2">{this.props.PercentForEachPlataformaConcorrente.facebook}%</div>
        </div>
        <Divider />
        ...
        <div className="ProfitFont2">{this.props.PercentForEachPlataformaConcorrente.yelp}%</div>
        </div>
        <Divider />
        ...
        <div className="ProfitFont2">{this.props.PercentForEachPlataformaConcorrente.googlereviews}%</div>
        </div>
        <Divider />
        ...
        <div className="ProfitFont2">{this.props.PercentForEachPlataformaConcorrente.tripadvisor}%</div>
        </div>
        <Divider />
        ...
        <div className="ProfitFont2">{this.props.PercentForEachPlataformaConcorrente.web}%</div>
        </div>
...
function mapStateToProps(state){
  return{
    PercentForEachPlataformaConcorrente: state.PercentForEachPlataformaConcorrente
  }
}
