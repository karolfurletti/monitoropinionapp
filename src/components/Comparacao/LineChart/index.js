        ...
        return (
            ...
            <ResponsiveContainer width="99%" height={250} className="responsiveGraph" strokeWidth={1}>
                <LineChart data={this.props.ChartOpinions[this.state.position]}className="LineChart" margin={margin} >
                    ...
                    <Line name="Essencia do Sabor" type="monotone" dataKey="pv" strokeOpacity={opacity.uv} strokeWidth={1} stroke="#2ca9d2" activeDot={{ r: 8 }} />
                    <Line name="Burguer King" type="monotone" dataKey="uv" strokeOpacity={opacity.pv} strokeWidth={1} stroke="#f99500" />
